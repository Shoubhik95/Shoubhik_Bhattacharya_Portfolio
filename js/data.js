const skillsData = [
  {
    ...
    themeRgb: "56, 189, 248",
    skills: [
      { name: "Unreal Engine 5", detail: "Blueprints, Lumen, Nanite, Metahuman", level: "PROD READY", percent: 92 },
      { name: "Unity 6", detail: "C#, New Input System, ProBuilder, DOTS", level: "PROD READY", percent: 90 },
      { name: "Blueprint Scripting", detail: "Visual Scripting, Event Graphs, Macros", level: "EXPERT", percent: 95 },
      { name: "VR/AR Integration", detail: "Locomotion Toolkit, Oculus SDK, Spatial Audio", level: "ADVANCED", percent: 85 }
    ]
  },
  {
    ...
    themeRgb: "34, 197, 94",
    skills: [
      { name: "C++", detail: "Memory Management, OOP, Game Loops", level: "ADVANCED", percent: 88 },
      { name: "C#", detail: "Unity Scripting, Async/Await, Events", level: "EXPERT", percent: 92 },
      { name: "Python", detail: "Data Processing, Automation, Scripts", level: "PROFICIENT", percent: 82 },
      { name: "Data Structures & OOP", detail: "Algorithms, Trees, Graphs, Design Patterns", level: "EXPERT", percent: 90 }
    ]
  },
  {
    category: "Game Design",
    icon: "🕹️",
    badge: "GAMEPLAY & EXPERIENCE",
    themeColor: "#a855f7",
    themeRgb: "168, 85, 247",
    skills: [
      { name: "Gameplay Systems", detail: "Core Loops, Inventory, Combat Mechanics", level: "EXPERT", percent: 94 },
      { name: "Game Mechanics", detail: "Physics Tuning, Character Controllers, Movement", level: "EXPERT", percent: 92 },
      { name: "Level Design", detail: "ProBuilder Blockout, Lighting, Flow", level: "ADVANCED", percent: 88 },
      { name: "Visual Storytelling", detail: "Environmental Narrative, Camera Composition", level: "ADVANCED", percent: 85 }
    ]
  },
  {
    category: "Technical Art & 3D",
    icon: "🎨",
    badge: "REALTIME 3D PIPELINE",
    themeColor: "#ec4899",
    themeRgb: "236, 72, 153",
    skills: [
      { name: "Blender 3D", detail: "Modeling, UV Unwrapping, Sculpting", level: "EXPERT", percent: 92 },
      { name: "Skeletal Rigging & Animation", detail: "Armature IK/FK, Weight Painting, Cycles", level: "ADVANCED", percent: 85 },
      { name: "Environment Art & Lighting", detail: "Procedural Shaders, Cycles, PBR Textures", level: "EXPERT", percent: 90 },
      { name: "Asset Optimization", detail: "Low-Poly Topology, LODs, Texture Atlases", level: "EXPERT", percent: 88 }
    ]
  },
  {
    ...
    themeRgb: "2, 132, 199",
    skills: [
      { name: "HTML5 & CSS3", detail: "Flexbox, Grid, Glassmorphism, Animations", level: "EXPERT", percent: 95 },
      { name: "JavaScript (ES6+)", detail: "DOM Manipulation, Web Audio, Async APIs", level: "EXPERT", percent: 90 },
      { name: "Figma UI/UX", detail: "Wireframing, High-Fidelity UI, Prototypes", level: "ADVANCED", percent: 88 },
      { name: "Firebase & APIs", detail: "Realtime Database, LocalStorage, Auth", level: "PROFICIENT", percent: 84 }
    ]
  },
  {
    ...
    themeRgb: "245, 158, 11",
    skills: [
      { name: "Git / GitHub", detail: "Branching, Version Control, CI/CD", level: "EXPERT", percent: 92 },
      { name: "VS Code & IDEs", detail: "Extensions, Debugging, Tooling", level: "EXPERT", percent: 95 },
      { name: "Unity / Unreal Editor", detail: "Project Build Config, Profiling, Asset Store", level: "EXPERT", percent: 94 },
      { name: "Real-Time Rendering", detail: "Shader Graph, PBR Materials, Post-Processing", level: "ADVANCED", percent: 86 }
    ]
  }
];

const gameProjectsData = [
  // Newly added projects come first!
  {
    id: "the-royal-king",
    category: "game-design",
    title: "King Runner",
...
const webProjectsData = [
  ...
  },
  {
    id: "tourism-project",
    category: "web-projects",
    title: "Chhattisgarh Tourism Website",
